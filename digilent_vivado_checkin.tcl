...
if {[file exists "$repo_path/.gitignore"] == 0} {
	puts "This repository does not contain a master gitignore. creating one now."
	...
	puts $file_obj "!src/other/**"
    puts $file_obj ""
	# TODO: automatically determine SDK app/bsp/hw_platform names
	puts $file_obj "# sdk workspace: edit this section to provide the correct names for APPLICATION, BSP, and HW_PLATFORM"
	puts $file_obj "sdk/**"
	puts $file_obj "!sdk/APPLICATION"
	puts $file_obj "sdk/APPLICATION/**"
	puts $file_obj "!sdk/APPLICATION/.project"
	puts $file_obj "!sdk/APPLICATION/.cproject"
	puts $file_obj "!sdk/APPLICATION/src"
	puts $file_obj "!sdk/APPLICATION/src/**"
	puts $file_obj "!sdk/BSP"
	puts $file_obj "sdk/BSP/**"
	puts $file_obj "!sdk/BSP/.project"
	puts $file_obj "!sdk/BSP/.cproject"
	puts $file_obj "!sdk/BSP/.sdkproject"
	puts $file_obj "!sdk/BSP/system.mss"
	puts $file_obj "!sdk/BSP/Makefile"
	puts $file_obj "!sdk/HW_PLATFORM"
	puts $file_obj "sdk/HW_PLATFORM/**"
	puts $file_obj "!sdk/HW_PLATFORM/.project"
    puts $file_obj ""
